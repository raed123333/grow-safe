...
public class AppUsageAdapter extends BaseAdapter {
    ...
    private List<com.growsafe.AppUsageModel> appUsageList;

    public AppUsageAdapter(Context context, List<com.growsafe.AppUsageModel> appUsageList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.growsafe.AppUsageModel appUsage = appUsageList.get(position);
